...
class DiscountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discount" do
    assert_difference("Discount.count") do
      post discounts_url, params: { discount: { Active: @discount.Active, Discount_percent: @discount.Discount_percent, Name: @discount.Name } }
    end
  ...
  test "should update discount" do
    patch discount_url(@discount), params: { discount: { Active: @discount.Active, Discount_percent: @discount.Discount_percent, Name: @discount.Name } }
